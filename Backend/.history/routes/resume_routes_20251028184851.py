...
prompt = f"""
You are an expert AI interviewer. Based on the candidate's resume, desired role, and job details, generate exactly 10 clear and relevant technical interview questions.
