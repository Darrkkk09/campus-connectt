...
async def get_interview_questions(
    ...
    Output:  A  list of 10 technical Questions relevant to the role without question numbers and  Give only the questions and for every question ending give  without any other text.
    """
    try:
