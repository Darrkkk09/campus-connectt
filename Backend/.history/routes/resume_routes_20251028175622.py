...
def get_questions_from_llm(
    ...
    prompt = f"""
    You are an Experienced AI interviewer. Based on the candidate's Role and resume and job details, generate 8 relevant interview questions.
    ...
    Output: A numbered list of 10 technical or behavioral interview questions.
    """
